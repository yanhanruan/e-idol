...
export const TRANSLATIONS: AppTranslations = {
  ja: {
    ...
    mostOrders: '接単最多',
    castListPage: {
      subtitle: 'あなたにぴったりのキャストを見つけよう',
      searchPlaceholder: 'キャスト名やゲーム名で検索',
      reserve: '予約する',
      reserveCast: 'このキャストを予約する',
      sortFeatured: 'おすすめ順',
      sortRating: '評価順',
      sortOrders: '人気順',
      sortPrice: '料金順',
    ...
    auth: {
      ...
      brandTagline: '次世代バーチャルエンターテインメント',
      brandDescription: 'デジタルインタラクションの未来へ。没入型バーチャル体験へのゲートウェイがあなたを待っています。',
      registerBrandTagline: 'バーチャルな旅を始めよう',
      registerBrandDescription: 'アカウントを作成して、没入型デジタル体験の世界へ踏み出しましょう。あなたの物語はここから始まります。',
    },
  },
  en: {
    home: 'Home',
    ...
    castListPage: {
      subtitle: 'Find your perfect cast companion',
      searchPlaceholder: 'Search by name or game',
      reserve: 'Reserve',
      reserveCast: 'Book this Cast',
      ...
      supportersTitle: 'Supporters TOP3',
    },
    games: {
      apex: 'Apex',
      lol: 'LoL',
    ...
    auth: {
      ...
      brandTagline: 'Next Generation Virtual Entertainment',
      brandDescription: 'Enter the future of digital interaction. Your gateway to immersive virtual experiences awaits.',
      registerBrandTagline: 'Begin Your Virtual Journey',
      registerBrandDescription: 'Create your account and step into a world of immersive digital experiences. Your story starts here.',
    },
  },
  zh: {
    home: '主页',
    ...
    auth: {
      ...
      rememberMe: '记住我',
      forgotPassword: '忘记密码？',
      orContinueWith: '或者通过以下方式继续',
      brandTagline: '次世代虚拟娱乐',
      brandDescription: '进入数字互动的未来。通往沉浸式虚拟体验的大门正等着你。',
      registerBrandTagline: '开启你的虚拟之旅',
      registerBrandDescription: '创建你的账号，步入沉浸式数字体验的世界。你的故事从这里开始。',
    },
  },
};
